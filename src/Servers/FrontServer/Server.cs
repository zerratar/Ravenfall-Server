...
namespace Shinobytes.Ravenfall.FrontServer
{
    internal class Server : IRavenServer
    {
            ...
            INetworkPacketController msNetworkPacketController)
        {
            ...
            logger.LogDebug("@whi@FrontServer@gray@+@whi@MasterServer ");
        ...
        public IRavenServer Start()
        {
            ...
            logger.LogDebug("@mag@started @gray@on port @gre@" + frontServerPort + "@gray@ and @gre@" + masterServerPort);
            return this;
        }
