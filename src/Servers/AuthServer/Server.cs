...
using Shinobytes.Ravenfall.AuthServer.PacketHandlers;
...
namespace Shinobytes.Ravenfall.AuthServer
{
    internal class Server : IRavenServer
    {
        ...
        public Server(ILogger logger, INetworkPacketController lsNetworkPacketController, INetworkPacketController msNetworkPacketController)
        {
            ...
            logger.LogDebug("@whi@LoginServer ");
        ...
        public IRavenServer Start()
        {
            ...
            logger.LogInformation("@mag@started @gray@on port @gre@" + loginServerPort);
            ...
            logger.LogDebug("Connected to MasterServer");
